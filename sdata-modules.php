...
* @Author: JOβING SQUAFD

* @Date: 2018-06-11 17:01:26

* @Last Modified by: Jobing Sahrul

* @Last Modified time: 2018-08-17 21:56:2
...

{
	...
	public function sdata($url = null , $custom = null){
		...
		curl_setopt($ch[$i], CURLOPT_COOKIEFILE, $cookies);
		 ...
		 if($custom[$i]['rto']){
		 	...
		 	curl_setopt($ch[$i], CURLOPT_TIMEOUT, 50);
	...
	public function cookies($length = 50) {
